...
{
    public partial class PrintPreviewPJ : Form
    {
        public PrintPreviewPJ (string outorgantecpf, string outorgantelogra, string outorgantebairro, string outorgantecep, string outorgantecidade,
        ...
        string outorgantecidadecom, string outorganteufcom, string dataatual)
        {
            ...
            reportViewer2.LocalReport.ReportEmbeddedResource = "WindowsFormsApp1.ProcPJ.rdlc";
